...
public class Melody {
   ...
   public boolean equals(Object o){//DOS MELODIAS SON IGUALES SI DURAN LOS MISMO Y TIENEN LAS MISMA NOTAS O NOTAS EQUIVALENTES
    ...
    public String toString() {
        ...
        StringBuilder notitas= new StringBuilder();
        for (Melody melodia : Melodylist) {
            if (melodia.accidental == Accidentals.SHARP) {
                notitas.append(melodia.note).append("#").append("(").append(melodia.time).append(") ");
            } else if (melodia.accidental == Accidentals.NATURAL) {
                notitas.append(melodia.note).append("(").append(melodia.time).append(") ");
            } else {
                notitas.append(melodia.note).append("b").append("(").append(melodia.time).append(") ");
            }
        }
        return notitas.toString().trim();
    }
}
